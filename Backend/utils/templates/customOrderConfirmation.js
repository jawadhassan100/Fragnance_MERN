const customOrderConfirmation = (fullName, totalPrice, shippingInfo, paymentMethod ,selectedPerfumes , perfumeNames) => {
       ...
       <div style="font-family: Arial, sans-serif; line-height: 1.6; color: #000; background-color: lightgray; padding: 20px;">
        <div style="max-width: 600px; margin: auto; border: 1px solid #000; padding: 20px;">
          ...
          <p style="font-size: 16px; margin: 10px 0;">
            ...
            <h2 style="color: #000; border-bottom: 1px solid #000; padding-bottom: 5px; >Perfume Details:</h2>
  ...
  module.exports = customOrderConfirmation;