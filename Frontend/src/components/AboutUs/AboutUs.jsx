    ...
    <div className="  min-h-screen pt-16 pb-8">
      ...
      <div className="container mx-auto px-4 ">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {/* Mission Card */}
          <div className="bg-white rounded-lg p-6 shadow-lg hover:shadow-xl transition-shadow duration-300 border-l-4 ">
          ...
          {/* Values Card */}
          <div className="bg-white rounded-lg p-6 shadow-lg hover:shadow-xl transition-shadow duration-300 border-l-4  md:col-span-2 lg:col-span-1">
            <div className="flex items-center mb-4">
              <div className="w-10 h-10 bg-black rounded-full flex items-center justify-center">
                <svg className="w-6 h-6 text-[#FDFBD4]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <h2 className=" text-2xl font-bold ml-4">Values</h2>
            </div>
