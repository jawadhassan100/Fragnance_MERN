...
const SingleProduct = () => {
    ...
    return (
      <div className="px-52 pt-16 grid grid-cols-1 lg:grid-cols-2 gap-10">
        {/* Left: Product Images */}
        <div>
  ...
  />
        ...
        <p className="text-sm text-gray-500 italic mb-2">{product.subtitle}</p>
        ...
        <ul className="text-sm text-gray-700 mb-4 space-y-1">
          ...
          <li><strong>Perfume Family:</strong> {product.perfumeFamily}</li>
          <li><strong>Longevity:</strong> {product.longevity}</li>
          <li><strong>Sillage:</strong> {product.sillage}</li>
        </ul>

        <button className="w-fit bg-black text-white py-2 px-6  hover:bg-gray-800 transition">
          Add to Cart
        </button>
      </div>
